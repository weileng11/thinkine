package com.gallery.coverflow.recyclerview;
...
import com.gallery.coverflow.CoverFlowLayoutManger;
import com.gallery.coverflow.RecyclerCoverFlow;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    private void intiCoverFlow(final ViewHolder holder) {
	    holder.coverFlow.setGreyItem(true); //设置灰度渐变
	    //        mList.setAlphaItem(true); //设置半透渐变
	    holder.coverFlow.setIntervalRatio(0.4f);
