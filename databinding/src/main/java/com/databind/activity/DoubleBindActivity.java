...
import com.databind.bean.DoubleBindBean;
import com.databind.bean.DoubleBindBean2;
import com.databind.databinding.ActivityDoubleBindBinding;
...
public class DoubleBindActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doubleBindBean2 = new DoubleBindBean2("我是原始内容3333");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.change_content_btn2:
                ...
                flag2 = !flag2;
                if (flag2) {
                    doubleBindBean2.setUsername("我是更新后的内容444");
                } else {
                    doubleBindBean2.setUsername("我是原始内容55555");
                }
                break;
